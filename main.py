...
# autoencoder.save("models/model_softmax_sigmoid")
autoencoder = load_model("models/model_softmax_sigmoid")

results = autoencoder.evaluate(train_ground, valid_ground, batch_size=128)
